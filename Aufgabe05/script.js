...
let artikel1 = {
    bild: "pillow3.jpeg",
    artikelname: "\"Brada – Gestreiftes Kisse\"",
...
let kissen = [artikel1, artikel2, artikel3];
//Sonstiges
let artikel4 = {
    bild: "Decor3.jpeg",
...
let sonstiges = [artikel4, artikel5, artikel6];
//Wohnaccesoires
//Art-Prints
let artikel7 = {
    bild: "Print1.jpg",
...
let artprints = [artikel7, artikel8, artikel9];
//Deko
let artikel10 = {
    bild: "Decor1.jpeg",
...
let deko = [artikel10, artikel11, artikel12];
//for-schleifen für Wohntextilien
//Kissen
for (let i = 0; i < kissen.length; i++) {
    ...
    //kaufen button
    let kaufen = document.createElement("form");
...
//Sonstiges
for (let i = 0; i < sonstiges.length; i++) {
